...
struct level_abx_t<Tx, Ty, std::enable_if_t<is_c2c_v<Tx, Ty>>>
  : public level_data_direct_t<Tx, Ty> {
  using Tw = add_complex_t<Tx>;

private:
  fft_func_t_t<Tw> *kernel_t_ = nullptr;
...
public:
  level_abx_t(int64_t n, int64_t n1, int64_t n2, int64_t howmany,
